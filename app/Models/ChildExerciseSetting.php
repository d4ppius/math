...
#[Fillable(['child_id', 'exercise_type_id', 'enabled', 'active_groups', 'session_duration_minutes', 'target_frequency', 'target_days', 'sound_enabled', 'show_timer', 'speed_bonus_enabled', 'show_hints', 'points'])]
